    ...
    WA.ui.actionBar.addButton({
        ...
        callback: (event) => {
            ...
            WA.ui.modal.openModal({
                ...
                allow: 'fullscreen',  // Autoriser le plein écran dans la modale
                position: 'center',  // Centrer la modale sur l'écran
                size: { width: 800, height: 600 }  // Définir la taille de la modale
            });
        }
    });
